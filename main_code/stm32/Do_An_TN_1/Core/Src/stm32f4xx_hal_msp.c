...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(ESP32_SCL_GPIO_Port, ESP32_SCL_Pin);

    HAL_GPIO_DeInit(ESP32_SDA_GPIO_Port, ESP32_SDA_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PB5     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, SCK_MAX7219_Pin|MISO_MAX7129_Pin|MOSI_MAX7129_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, ENCODER_L1_Pin|ENCODER_L2_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, TX_ESP32_Pin|RX_ESP32_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, TX_HC05_Pin|RX_HC05_Pin);
